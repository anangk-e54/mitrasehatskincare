        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="contact-form">
                    <form id="contact" method="post" action="/promotion/{{$promotion->id}}"
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <fieldset>
                                    ...
                                    <input name="name" type="text" class="form-control" id="name"
                                        placeholder="Product Name" required="" value="{{ $promotion->name }}">
                                </fieldset>
                            </div>
                            <div class=" col-lg-12 col-md-12 col-sm-12">
                                <fieldset>
                                    ...
                                    <select name="category" type="text" class="form-control" id="category"
                                        ...
                                        <option value="{{ $promotion->category }}">{{ $promotion->category }}</option>
                            ...
                            <div class="col-lg-12">
                                <img src="{{  $promotion->getImage1() }}" alt="">
                                <fieldset>
